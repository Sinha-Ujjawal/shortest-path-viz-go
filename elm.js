...
{
	if (region.A.aE === region.v.aE)
	{
		return 'on line ' + region.A.aE;
	}
	return 'on lines ' + region.A.aE + ' through ' + region.v.aE;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b3: 'hidden', bZ: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b3: 'mozHidden', bZ: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b3: 'msHidden', bZ: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b3: 'webkitHidden', bZ: 'webkitvisibilitychange' }
		: { b3: 'hidden', bZ: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bs: fragment, bt: host, P: path, bC: port_, bF: protocol, bG: query};
	});
...
var $author$project$Main$ST = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Main$SetPath = function (a) {
	return {$: 8, a: a};
};
...
var $author$project$Main$subscribeForBFSPath = _Platform_incomingPort(
	'subscribeForBFSPath',
...
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$subscribeForBFSPath($author$project$Main$SetPath);
};
var $elm$core$String$cons = _String_cons;
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ae: charsProcessed, al: hash, Z: seed, aq: shift};
	});
...
var $robinheghan$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.al)) ? (data.Z ^ A2(
		...
		A2(
			...
			15,
			A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, data.al)))) : data.Z;
	var h0 = acc ^ data.ae;
...
var $robinheghan$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {ae: data.ae + 1, al: res, Z: data.Z, aq: data.aq + 8};
		}
	});
...
var $author$project$Main$End = 1;
var $author$project$Main$Obstacle = 2;
...
var $author$project$Main$symbolTypeAtPosition = F2(
	function (model, _v0) {
		var rowId = _v0.a;
		var colId = _v0.b;
		return _Utils_eq(
			...
			model.A) ? $elm$core$Maybe$Just(0) : (_Utils_eq(
			$elm$core$Maybe$Just(
				_Utils_Tuple2(rowId, colId)),
			model.v) ? $elm$core$Maybe$Just(1) : (A2(
			$elm$core$Set$member,
			_Utils_Tuple2(rowId, colId),
			model.r) ? $elm$core$Maybe$Just(2) : $elm$core$Maybe$Nothing));
	});
var $author$project$Main$applyClickButtonTypeOnCell = F2(
	function (_v0, model) {
		var rowId = _v0.a;
		var colId = _v0.b;
		var modelWithButtonApplied = function () {
			var _v1 = A2(
				$author$project$Main$symbolTypeAtPosition,
				model,
				_Utils_Tuple2(rowId, colId));
			if (!_v1.$) {
				var st = _v1.a;
...
var $author$project$Main$requestForBFS = _Platform_outgoingPort(
	'requestForBFS',
	function ($) {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 4:
				return A3($author$project$Main$initModel, model.u, model.w, 0);
			case 1:
			...
			case 2:
				var pos = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Main$applyClickButtonTypeOnCell, pos, model),
					$elm$core$Platform$Cmd$none);
			case 3:
				var _v1 = _Utils_Tuple2(model.A, model.v);
				if ((!_v1.a.$) && (!_v1.b.$)) {
					var start = _v1.a.a;
					var end = _v1.b.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{l: true}),
						$author$project$Main$requestForBFS(
							{
								B: model.B,
								v: end,
								w: model.w,
			...
			case 6:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{w: height, P: $elm$core$Set$empty}),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{B: !model.B, P: $elm$core$Set$empty}),
					$elm$core$Platform$Cmd$none);
			default:
				var path = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							l: false,
							P: $elm$core$Set$fromList(
								$elm$core$Array$toList(path))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$ToogleDiagonal = {$: 7};
...
var $author$project$Main$checkBox = F4(
	function (isDisabled, label, isChecked, event) {
		return A2(
	...
	function (declaration, _v0) {
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.b_) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.b9, record.b_, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	var charset = _v0.bn;
	var imports = _v0.bu;
	var namespaces = _v0.bz;
	var declarations = _v0.b$;
	return {
		bn: charset,
		b$: $rtfeldman$elm_css$Css$Structure$compactDeclarations(declarations),
		bu: imports,
		bz: namespaces
	};
};
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bn: charset, b$: declarations, bu: imports, bz: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bn: $elm$core$Maybe$Nothing, bu: _List_Nil, bz: _List_Nil, bL: snippets};
};
...
var $author$project$Main$drawButton = F3(
	function (isDisabled, buttonText, msg) {
		return A4(
...
var $author$project$Main$Delete = {$: 1};
var $author$project$Main$SwitchClickButtonType = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$drawDeleteButton = function (isDisabled) {
	return A3(
		$author$project$Main$drawButton,
		isDisabled,
		'x',
		$author$project$Main$SwitchClickButtonType($author$project$Main$Delete));
};
var $author$project$Main$symbolTypeToString = function (cb) {
	switch (cb) {
		case 0:
			return '🟢';
		case 1:
...
var $author$project$Main$drawEndButton = function (isDisabled) {
	return A3(
		$author$project$Main$drawButton,
		isDisabled,
		$author$project$Main$symbolTypeToString(1),
		$author$project$Main$SwitchClickButtonType(
			$author$project$Main$ST(1)));
};
var $author$project$Main$ApplyClickButtonTypeOnCell = function (a) {
	return {$: 2, a: a};
};
var $author$project$Utils$cartesianProduct = F2(
	function (aitems, bitems) {
		return A2(
			$elm$core$List$concatMap,
			function (a) {
				return A2(
...
var $rtfeldman$elm_css$Css$prop3 = F4(
	function (key, argA, argB, argC) {
		return A2($rtfeldman$elm_css$Css$property, key, argA.G + (' ' + (argB.G + (' ' + argC.G))));
	});
var $rtfeldman$elm_css$Css$border3 = $rtfeldman$elm_css$Css$prop3('border');
var $author$project$MyCss$cellSideLengthPixels = 30;
...
var $rtfeldman$elm_css$Css$solid = {o: 0, _: 0, G: 'solid'};
var $rtfeldman$elm_css$Css$width = $rtfeldman$elm_css$Css$prop1('width');
var $author$project$MyCss$gridItem = _List_fromArray(
	[
		A3(
		$rtfeldman$elm_css$Css$border3,
		$rtfeldman$elm_css$Css$px(1.0),
		$rtfeldman$elm_css$Css$solid,
		A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.8)),
		$rtfeldman$elm_css$Css$height(
		$rtfeldman$elm_css$Css$px($author$project$MyCss$cellSideLengthPixels)),
...
var $author$project$MyCss$styledNode = A2($rtfeldman$elm_css$Html$Styled$styled, $rtfeldman$elm_css$Html$Styled$div, $author$project$MyCss$gridItem);
var $author$project$Main$emptyCell = function (attrs) {
	return A2($author$project$MyCss$styledNode, attrs, _List_Nil);
};
var $author$project$Main$endCell = function (attrs) {
	return A2(
		$author$project$MyCss$styledNode,
		attrs,
		_List_fromArray(
			[
...
var $author$project$Main$obstacleCell = function (attrs) {
	return A2(
		$author$project$MyCss$styledNode,
		attrs,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(
				$author$project$Main$symbolTypeToString(2))
			]));
};
...
var $author$project$MyCss$withBackgroundColor = F2(
	function (color, selm) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$styled,
			selm,
...
var $author$project$MyCss$withBackgroundBlack = $author$project$MyCss$withBackgroundColor(
	A3($rtfeldman$elm_css$Css$rgb, 0, 0, 0));
var $author$project$Main$pathCell = function (attrs) {
	return A3($author$project$MyCss$withBackgroundBlack, $author$project$MyCss$styledNode, attrs, _List_Nil);
};
var $author$project$Main$startCell = function (attrs) {
	return A2(
		$author$project$MyCss$styledNode,
		attrs,
		_List_fromArray(
...
var $author$project$MyCss$repeat = F2(
	function (n, px) {
		return 'repeat(' + ($elm$core$String$fromInt(n) + (', ' + ($elm$core$String$fromFloat(px) + 'px)')));
	});
var $author$project$MyCss$gridContainer = function (width) {
	return _List_fromArray(
		[
			...
			A2($author$project$MyCss$repeat, width, $author$project$MyCss$cellSideLengthPixels)),
			A2($rtfeldman$elm_css$Css$property, 'grid-template-rows', 'auto'),
			A2($rtfeldman$elm_css$Css$property, 'grid-gap', '10px')
		]);
};
var $author$project$MyCss$styledGrid = function (width) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$styled,
		$rtfeldman$elm_css$Html$Styled$div,
		$author$project$MyCss$gridContainer(width));
};
var $author$project$Main$drawGrid = F2(
	function (isDisabled, model) {
		var rowIds = A2($elm$core$List$range, 1, model.w);
		var renderCell = function (_v0) {
			...
			var cell = _Utils_eq(
				$elm$core$Maybe$Just(
					_Utils_Tuple2(rowId, colId)),
				model.A) ? $author$project$Main$startCell : (_Utils_eq(
				$elm$core$Maybe$Just(
					_Utils_Tuple2(rowId, colId)),
				model.v) ? $author$project$Main$endCell : (A2(
				$elm$core$Set$member,
				_Utils_Tuple2(rowId, colId),
				model.r) ? $author$project$Main$obstacleCell : (A2(
				$elm$core$Set$member,
				_Utils_Tuple2(rowId, colId),
				model.P) ? $author$project$Main$pathCell : $author$project$Main$emptyCell)));
			return cell(
				isDisabled ? _List_Nil : _List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick(
						$author$project$Main$ApplyClickButtonTypeOnCell(
							_Utils_Tuple2(rowId, colId)))
					]));
		};
		var colIds = A2($elm$core$List$range, 1, model.u);
		var elements = A2(
			$elm$core$List$map,
			renderCell,
			A2($author$project$Utils$cartesianProduct, rowIds, colIds));
		return A3($author$project$MyCss$styledGrid, model.u, _List_Nil, elements);
	});
var $author$project$Main$drawObstacleButton = function (isDisabled) {
	return A3(
		$author$project$Main$drawButton,
		isDisabled,
		$author$project$Main$symbolTypeToString(2),
		$author$project$Main$SwitchClickButtonType(
			$author$project$Main$ST(2)));
};
var $author$project$Main$drawStartButton = function (isDisabled) {
	return A3(
		$author$project$Main$drawButton,
		isDisabled,
		$author$project$Main$symbolTypeToString(0),
			...
			[
				...
				function () {
					...
					if (!_v0.$) {
						...
						return 'Click on grid cell to clear the symbol';
					}
				}())
			]));
};
...
var $author$project$Main$slider = F6(
	function (isDisabled, label, labelValue, min, max, mkEvent) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_Nil,
			_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return A4(
		...
		_List_fromArray(
			[
				A2($author$project$Main$drawGrid, model.l, model),
				A4(
				$rtfeldman$elm_css$Html$Styled$styled,
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$author$project$Main$drawStartButton(model.l),
						$author$project$Main$drawEndButton(model.l),
						$author$project$Main$drawObstacleButton(model.l),
						$author$project$Main$drawDeleteButton(model.l)
					])),
				$author$project$Main$printCurrentClickButtonTypeMessage(model),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
				_List_fromArray(
					[
						A3($author$project$Main$drawButton, model.l, 'Compute Path', $author$project$Main$ComputePath)
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
				_List_fromArray(
					[
						A3($author$project$Main$drawButton, model.l, 'Reset', $author$project$Main$Reset)
					])),
				A6($author$project$Main$slider, model.l, 'Width', model.u, $author$project$Main$minWidth, $author$project$Main$maxWidth, $author$project$Main$SetWidth),
				A6($author$project$Main$slider, model.l, 'Height', model.w, $author$project$Main$minHeight, $author$project$Main$maxHeight, $author$project$Main$SetHeight),
				A4($author$project$Main$checkBox, model.l, 'Allow Diagonal', model.B, $author$project$Main$ToogleDiagonal)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		b6: A2($author$project$Main$initModel, $author$project$Main$minWidth, $author$project$Main$minHeight),
		ch: $author$project$Main$subscriptions,
		cj: $author$project$Main$update,
		cl: A2($elm$core$Basics$composeR, $author$project$Main$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
